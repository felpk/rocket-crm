        ...
        {STAGES.map((stage) => {
          ...
          return (
            ...
            >
              ...
              {/* Column body */}
              <div className="bg-card/30 rounded-xl p-2 min-h-[400px] space-y-2">
                {stageLeads.map((lead) => (
                  <div
                    key={lead.id}
                    draggable
                    onDragStart={() => setDraggedLead(lead.id)}
                    className="bg-card rounded-lg p-4 cursor-grab active:cursor-grabbing hover:ring-1 hover:ring-accent/30 transition-all"
                  >
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-accent hover:bg-accent/80 py-3 rounded-lg font-medium transition-colors"
              >
